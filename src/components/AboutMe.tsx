  ...
  return (
    <div className="aboutMeText">
      <p className="text-foreground">
        ...
        small snippets of code to help me and others with various tasks. In
        March 2021 I decided to take a huge professional risk. I quit my
        comfortable full-time job and joined a coding bootcamp. I loved every
        minute of the bootcamp. I woke up early to start coding before anyone
